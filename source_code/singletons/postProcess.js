...
import {ASSERT, headlessMode, glCreateProgram, glCreateTexture, engineAddPlugin, glEnable, glFlush, mainContext, glCanvas, overlayCanvas, glContext, glGeometryBuffer, mainCanvas, time} from "littlejsengine";
...
{
    console.log("initialising post processing");
